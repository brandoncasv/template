        ...
        <header id="header" data-transparent="true" class="dark">
            <div class="header-inner">
                <div class="container">
                    <!--Logo-->
                    <div id="logo">
                        <a href="index.html" class="logo" data-src-dark="{{asset('polo/images/logo-dark.png')}}">
                    ...
                    <!--End: Logo-->
                                        ...
                                        <!-- Search -->
                    <div id="search">
                        <div id="search-logo"><img src="{{asset('polo/images/logo.png')}}" alt="Polo Logo"></div>
                                        ...
                                        <div class="widget-mycart">
                                            ...
                                            <div class="cart-item">
                                                <div class="cart-image"> <a href="#"><img
                                                            src="{{asset('polo/images/shop/products/10.jpg')}}"></a></div>
                                            ...
                                            <div class="cart-item">
                                                <div class="cart-image"> <a href="#"><img
                                                            src="{{asset('polo/images/shop/products/11.jpg')}}"></a></div>
                                                <div class="cart-product-meta">
...
<div id="slider" class="inspiro-slider slider-fullscreen arrows-large arrows-creative dots-creative">
    ...
    <!-- Slide 1 -->
    <div class="slide background-overlay-gradient kenburns background-image" style="background-image:url('{{asset('polo/images/slider/notgeneric_bg3.jpg')}}');">
        <div class="container">
    ...
    <!-- Slide 2 -->
    <div class="slide background-overlay-gradient kenburns background-image" style="background-image:url('{{asset('polo/images/slider/pattern.png')}}');">
        <div class="container">
...
<!--end: Inspiro Slider -->
        ...
        <section id="welcome" class="p-b-0">
            <div class="container">
                ...
                <div class="row" data-animate="fadeInUp">
                    <div class="col-lg-12">
                        <img class="img-fluid" src="{{asset('polo/images/other/responsive-1.jpg')}}" alt="Welcome to POLO">
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="portfolio">
                ...
                <div id="portfolio" class="grid-layout portfolio-4-columns" data-margin="0">
                        ...
                        <div class="portfolio-item-wrap">
                            <div class="portfolio-slider">
                                <div class="carousel dots-inside dots-dark arrows-dark" data-items="1" data-loop="true" data-autoplay="true" data-animate-in="fadeIn" data-animate-out="fadeOut" data-autoplay-timeout="1500">
                                    <a href="#"><img src="{{asset('polo/images/portfolio/64.jpg')}}" alt=""></a>
                                    <a href="#"><img src="{{asset('polo/images/portfolio/70.jpg')}}" alt=""></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="portfolio-item img-zoom ct-photography ct-marketing ct-media">
                        <div class="portfolio-item-wrap">
                            <div class="portfolio-image">
                                <a href="#"><img src="{{asset('polo/images/portfolio/60.jpg')}}" alt=""></a>
                            </div>
                    ...
                    <div class="portfolio-item img-zoom ct-photography ct-media ct-branding ct-Media">
                        <div class="portfolio-item-wrap">
                            <div class="portfolio-image">
                                <a href="#"><img src="{{asset('polo/images/portfolio/61.jpg')}}" alt=""></a>
                            </div>
                            <div class="portfolio-description">
                    ...
                    <div class="portfolio-item img-zoom ct-photography ct-media ct-branding ct-marketing ct-webdesign">
                        <div class="portfolio-item-wrap">
                            <div class="portfolio-image">
                                <a href="#"><img src="{{asset('polo/images/portfolio/65.jpg')}}" alt=""></a>
                            </div>
                    ...
                    <div class="portfolio-item img-zoom ct-marketing ct-media ct-branding ct-marketing ct-webdesign">
                        <div class="portfolio-item-wrap">
                            <div class="portfolio-image">
                                <a href="#"><img src="{{asset('polo/images/portfolio/66.jpg')}}" alt=""></a>
                            </div>
                            <div class="portfolio-description">
                                <a href="portfolio-page-grid-gallery.html">
                    ...
                    <div class="portfolio-item img-zoom ct-photography ct-media ct-branding ct-marketing ct-webdesign">
                        <div class="portfolio-item-wrap">
                            <div class="portfolio-image">
                                <a href="#"><img src="{{asset('polo/images/portfolio/67.jpg')}}" alt=""></a>
                            </div>
                            <div class="portfolio-description">
                    ...
                    <div class="portfolio-item no-overlay ct-photography ct-media ct-branding ct-Media ct-marketing ct-webdesign">
                        <div class="portfolio-item-wrap">
                            <div class="portfolio-slider">
                                <div class="carousel dots-inside dots-dark arrows-dark" data-items="1" data-loop="true" data-autoplay="true" data-animate-in="fadeIn" data-animate-out="fadeOut" data-autoplay-timeout="1500">
                                    <a href="#"><img src="{{asset('polo/images/portfolio/68.jpg')}}" alt=""></a>
                                    <a href="#"><img src="{{asset('polo/images/portfolio/71.jpg')}}" alt=""></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="portfolio-item img-zoom ct-photography ct-marketing ct-media">
                        <div class="portfolio-item-wrap">
                            <div class="portfolio-image">
                                <a href="#"><img src="{{asset('polo/images/portfolio/69.jpg')}}" alt=""></a>
                            </div>
                            <div class="portfolio-description">
                                <a href="portfolio-page-grid-gallery.html">
                                    <h3>Luxury Wine</h3>
        ...
        <!-- COUNTERS -->
        <section class="text-light p-t-150 p-b-150 background-overlay" data-parallax-image="{{asset('polo/images/parallax/12.jpg')}}">
            <div class="container">
                <div class="row">
                    <div class="col-lg-3">
                ...
                <div id="blog" class="grid-layout post-3-columns m-b-30" data-item="post-item">
                    ...
                    <div class="post-item border">
                        <div class="post-item-wrap">
                            <div class="post-image">
                                <a href="#">
                                    <img alt="" src="{{asset('polo/images/blog/12.jpg')}}">
                                </a>
                    ...
                    <div class="post-item border">
                        <div class="post-item-wrap">
                            <div class="post-image">
                                <a href="#">
                                    <img alt="" src="{{asset('polo/images/blog/17.jpg')}}">
                                </a>
                    ...
                    <div class="post-item border">
                        <div class="post-item-wrap">
                            <div class="post-image">
                                <a href="#">
                                    <img alt="" src="{{asset('polo/images/blog/18.jpg')}}">
                                </a>
                                <span class="post-meta-category"><a href="">Science</a></span>
                            </div>
                            <div class="post-item-description">
        ...
        <section class="p-t-60">
            <div class="container">
                ...
                <div class="carousel" data-items="6" data-items-sm="4" data-items-xs="3" data-items-xxs="2" data-margin="20" data-arrows="false" data-autoplay="true" data-autoplay-timeout="3000" data-loop="true">
                    <div>
                        <a href="#"><img alt="" src="{{asset('polo/images/clients/1.png')}}"> </a>
                    </div>
                    <div>
                        <a href="#"><img alt="" src="{{asset('polo/images/clients/2.png')}}"> </a>
                    </div>
                    <div>
                        <a href="#"><img alt="" src="{{asset('polo/images/clients/3.png')}}"> </a>
                    </div>
                    <div>
                        <a href="#"><img alt="" src="{{asset('polo/images/clients/4.png')}}"> </a>
                    </div>
                    <div>
                        <a href="#"><img alt="" src="{{asset('polo/images/clients/5.png')}}"> </a>
                    </div>
                    <div>
                        <a href="#"><img alt="" src="{{asset('polo/images/clients/6.png')}}"> </a>
                    </div>
                    <div>
                        <a href="#"><img alt="" src="{{asset('polo/images/clients/7.png')}}"> </a>
                    </div>
                    <div>
                        <a href="#"><img alt="" src="{{asset('polo/images/clients/8.png')}}"> </a>
                    </div>
                    <div>
                        <a href="#"><img alt="" src="{{asset('polo/images/clients/9.png')}}"> </a>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="row team-members">
                    <div class="col-lg-3">
                        <div class="team-member">
                            <div class="team-image">
                                <img src="{{asset('polo/images/team/6.jpg')}}">
                            </div>
                            <div class="team-desc">
                                <h3>Alea Smith</h3>
                    ...
                    <div class="col-lg-3">
                        <div class="team-member">
                            <div class="team-image">
                                <img src="{{asset('polo/images/team/7.jpg')}}">
                            </div>
                            <div class="team-desc">
                                <h3>Ariol Doe</h3>
                                <span>Software Developer</span>
                    ...
                    <div class="col-lg-3">
                        <div class="team-member">
                            <div class="team-image">
                                <img src="{{asset('polo/images/team/8.jpg')}}">
                            </div>
                            <div class="team-desc">
                                <h3>Emma Ross</h3>
                                <span>Software Developer</span>
                    ...
                    <div class="col-lg-3">
                        <div class="team-member">
                            <div class="team-image">
                                <img src="{{asset('polo/images/team/9.jpg')}}">
                            </div>
                            <div class="team-desc">
                                <h3>Victor Loda</h3>
                                <span>Software Developer</span>
